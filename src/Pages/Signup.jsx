...
import { craeteAccont } from "../Redux/Slices/AuthSlice";
...
function Signup(params) {
    ...
    async function createNewAccount(event){
        ...
        if(!signupData.password.match(/^(?=.*\d)(?=.*[a-zA-Z])[a-zA-Z0-9]{7,}$/)){
            toast.error('Password should be at least one digit,one lower case,one upper case, 8 from the mentioned characters');
            return
        }
        ...
        const response = await dispatch(craeteAccont(formData));
